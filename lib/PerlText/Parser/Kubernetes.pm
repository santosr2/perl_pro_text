package PerlText::Parser::Kubernetes;
use v5.36;
use Moo;
...
PerlText::Parser::Kubernetes - Parser for Kubernetes pod logs

=head1 SYNOPSIS

    use PerlText::Parser::Kubernetes;

    my $parser = PerlText::Parser::Kubernetes->new;
