...
PerlText::Config - Configuration management for PerlText Pro

=head1 SYNOPSIS

    use PerlText::Config;

    my $config = PerlText::Config->new;
...
Manages configuration for PerlText Pro from files and environment variables.
