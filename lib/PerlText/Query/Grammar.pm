package PerlText::Query::Grammar;
use v5.36;
use Moo;
use Marpa::R2;
...
PerlText::Query::Grammar - Marpa::R2 grammar for PerlText query language

=head1 DESCRIPTION

Defines the BNF grammar for PerlText's log query language using Marpa::R2.
