...
Sift::Schema - Unified event schema definitions
...
=head1 SYNOPSIS
    ...
    my $schema = Sift::Schema->get('nginx');
    ...
    my $names = Sift::Schema->available;

    # Register a custom schema
    my $custom = Sift::Schema->new(
        name   => 'myapp',
        fields => {
