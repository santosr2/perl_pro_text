...
sub _build_parser ($self) {
    return Sift::Parser::Detector->new;
}
...
Sift::Pro - Unified, intelligent log querying and correlation engine
...
Sift Pro is a unified, intelligent log querying and correlation engine.
