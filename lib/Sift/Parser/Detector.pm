...
sub _build_parsers ($self) {
    return [
        Sift::Parser::Nginx->new,
        Sift::Parser::Apache->new,
        Sift::Parser::JSON->new,
        Sift::Parser::Syslog->new,
    ];
}
...
Sift::Parser::Detector - Auto-detect log format from sample lines
