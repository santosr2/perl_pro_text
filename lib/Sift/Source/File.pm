...
Sift::Source::File - Read log events from local files
...
=head1 SYNOPSIS
    ...
    # Single file
    my $source = Sift::Source::File->new(path => '/var/log/nginx/access.log');

    # Glob pattern
    my $source = Sift::Source::File->new(path => '/var/log/nginx/*.log');
...
matching multiple files. Auto-detects log format using Sift::Parser::Detector.
