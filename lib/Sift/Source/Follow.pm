...
Sift::Source::Follow - Follow (tail -f) log files

=head1 SYNOPSIS

    use Sift::Source::Follow;
    use Sift::Parser::Nginx;

    my $parser = Sift::Parser::Nginx->new;

    my $follower = Sift::Source::Follow->new(
